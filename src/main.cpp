...
private:
    ...
    void createGraphicsPipeline() {
        auto meshShaderCode = readFile(std::string(SOURCE_DIR) + "/src/shaders/mesh.spv");
        auto fragShaderCode = readFile(std::string(SOURCE_DIR) + "/src/shaders/frag.spv");
